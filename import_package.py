...
label1 = tk.Label(root, text='Enter Package Name:', bg='gray90')
...
button3 = tk.Button(text='  Md.Kawsar Ahmed  ', bg='red', fg='white',
                    font=('helvetica', 12, 'bold'))
canvas1.create_window(150, 300, window=button3)
